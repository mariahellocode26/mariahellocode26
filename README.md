...
| **DevOps & Tools** | Git, GitHub Actions, CI/CD, Docker, Claude Code, AI-Driven Spec-to-Cod, CLI, AWS (S3, EC2, API Gateway, Lambda, CDK, Step Functions, Cloud Watch alarms and dashboards, SQS, SNS) |
