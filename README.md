...
-  ⭐️ I like building AI systems that are not only capable, but also evaluated, observable, and maintainable.
...
| **DevOps & Tools** | Git, GitHub Actions, CI/CD, Docker, Linux, AI-Driven Spec-to-Cod, CLI, AWS (S3, EC2, API Gateway, Lambda, CDK, Step Functions, Cloud Watch alarms and dashboards, SQS, SNS, AWS CDK, CloudFormation), GCP (Firestore) |
